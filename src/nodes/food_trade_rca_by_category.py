"""Transform Food Trade Rca By Category data."""
...
def test(table: pa.Table) -> None:
    """Validate food_trade_rca_by_category dataset."""
...
def run():
    """Transform food_trade_rca_by_category data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("food_trade_rca_by_category")
    #
    # records = []
    # for row in raw:
    #     records.append({
