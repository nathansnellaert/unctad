"""Transform Liner Shipping Connectivity Annual data."""
...
METADATA = {
    "title": "UNCTAD Liner Shipping Connectivity (Annual)",
...
def test(table: pa.Table) -> None:
    """Validate liner_shipping_connectivity_annual dataset."""
...
def run():
    """Transform liner_shipping_connectivity_annual data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("liner_shipping_connectivity_annual")
    #
    # records = []
    # for row in raw:
    #     records.append({
