"""Transform Liner Shipping Bilateral Connectivity data."""
...
def test(table: pa.Table) -> None:
    """Validate liner_shipping_bilateral_connectivity dataset."""
...
def run():
    """Transform liner_shipping_bilateral_connectivity data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("liner_shipping_bilateral_connectivity")
    #
    # records = []
    # for row in raw:
    #     records.append({
