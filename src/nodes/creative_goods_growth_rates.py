"""Transform Creative Goods Growth Rates data."""
...
def test(table: pa.Table) -> None:
    """Validate creative_goods_growth_rates dataset."""
...
def run():
    """Transform creative_goods_growth_rates data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("creative_goods_growth_rates")
    #
    # records = []
    # for row in raw:
    #     records.append({
