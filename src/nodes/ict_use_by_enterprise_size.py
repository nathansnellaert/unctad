"""Transform Ict Use By Enterprise Size data."""
...
def test(table: pa.Table) -> None:
    """Validate ict_use_by_enterprise_size dataset."""
...
def run():
    """Transform ict_use_by_enterprise_size data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("ict_use_by_enterprise_size")
    #
    # records = []
    # for row in raw:
    #     records.append({
