"""Transform Population Dependency Ratios data."""
...
def test(table: pa.Table) -> None:
    """Validate population_dependency_ratios dataset."""
...
def run():
    """Transform population_dependency_ratios data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("population_dependency_ratios")
    #
    # records = []
    # for row in raw:
    #     records.append({
