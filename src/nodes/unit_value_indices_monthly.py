"""Transform Unit Value Indices Monthly data."""
...
def test(table: pa.Table) -> None:
    """Validate unit_value_indices_monthly dataset."""
...
def run():
    """Transform unit_value_indices_monthly data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("unit_value_indices_monthly")
    #
    # records = []
    # for row in raw:
    #     records.append({
