"""Transform Associated Plastics Trade data."""
...
METADATA = {
    "title": "UNCTAD Associated Plastics Trade",
...
def test(table: pa.Table) -> None:
    """Validate associated_plastics_trade dataset."""
...
def run():
    """Transform associated_plastics_trade data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("associated_plastics_trade")
    #
    # records = []
    # for row in raw:
    #     records.append({
