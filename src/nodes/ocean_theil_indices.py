...
UNCTAD_DATASET_ID = "US.OceanTheilIndicesIndividualEconomies"
SUBSET_DATASET_ID = "unctad_ocean_theil_indices"
...
def transform():
    ...
    merge(table, SUBSET_DATASET_ID, key=['_year', 'economy', 'product', 'flow'])
