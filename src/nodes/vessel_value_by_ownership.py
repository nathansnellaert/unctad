"""Transform Vessel Value By Ownership data."""
...
def test(table: pa.Table) -> None:
    """Validate vessel_value_by_ownership dataset."""
...
def run():
    """Transform vessel_value_by_ownership data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("vessel_value_by_ownership")
    #
    # records = []
    # for row in raw:
    #     records.append({
