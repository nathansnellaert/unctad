"""Transform Ocean Exports Per Capita Individual data."""
...
METADATA = {
    "title": "UNCTAD Ocean Exports Per Capita (Individual)",
...
def test(table: pa.Table) -> None:
    """Validate ocean_exports_per_capita_individual dataset."""
...
def run():
    """Transform ocean_exports_per_capita_individual data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("ocean_exports_per_capita_individual")
    #
    # records = []
    # for row in raw:
    #     records.append({
