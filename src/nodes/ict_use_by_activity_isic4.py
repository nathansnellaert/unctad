"""Transform Ict Use By Activity Isic4 data."""
...
METADATA = {
    "title": "UNCTAD ICT Use by Activity (ISIC4)",
...
def test(table: pa.Table) -> None:
    """Validate ict_use_by_activity_isic4 dataset."""
...
def run():
    """Transform ict_use_by_activity_isic4 data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("ict_use_by_activity_isic4")
    #
    # records = []
    # for row in raw:
    #     records.append({
