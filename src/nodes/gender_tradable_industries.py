"""Transform Gender Tradable Industries data."""
...
METADATA = {
    "title": "UNCTAD Gender Tradable Industries",
...
def test(table: pa.Table) -> None:
    """Validate gender_tradable_industries dataset."""
...
def run():
    """Transform gender_tradable_industries data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("gender_tradable_industries")
    #
    # records = []
    # for row in raw:
    #     records.append({
