"""Transform Ocean Trade Regional data."""
...
METADATA = {
    "title": "UNCTAD Ocean Trade (Regional Aggregates)",
...
def test(table: pa.Table) -> None:
    """Validate ocean_trade_regional dataset."""
