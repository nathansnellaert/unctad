"""Transform Digitally Deliverable Services data."""
...
def test(table: pa.Table) -> None:
    """Validate digitally_deliverable_services dataset."""
...
def run():
    """Transform digitally_deliverable_services data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("digitally_deliverable_services")
    #
    # records = []
    # for row in raw:
    #     records.append({
