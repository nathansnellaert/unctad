...
UNCTAD_DATASET_ID = "US.PopAgeStruct"
SUBSET_DATASET_ID = "unctad_population_structure_by_age_gender"
...
def transform():
    ...
    merge(table, SUBSET_DATASET_ID, key=['_year', 'economy', 'sex', 'ageclass'])
