"""Transform Liner Shipping Connectivity Monthly data."""
...
METADATA = {
    "title": "UNCTAD Liner Shipping Connectivity (Monthly)",
...
def test(table: pa.Table) -> None:
    """Validate liner_shipping_connectivity_monthly dataset."""
...
def run():
    """Transform liner_shipping_connectivity_monthly data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("liner_shipping_connectivity_monthly")
    #
    # records = []
    # for row in raw:
    #     records.append({
