"""Transform Port Calls Arrivals Ships data."""
...
METADATA = {
    "title": "UNCTAD Port Calls Arrivals by Ships",
...
def test(table: pa.Table) -> None:
    """Validate port_calls_arrivals_ships dataset."""
...
def run():
    """Transform port_calls_arrivals_ships data."""
    raise NotImplementedError("Transform not yet implemented - profile raw data first")

    # raw = load_raw("port_calls_arrivals_ships")
    #
    # records = []
    # for row in raw:
    #     records.append({
